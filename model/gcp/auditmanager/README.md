...
Use `swamp model type describe @swamp/gcp/auditmanager/auditreports` to see the
...
```bash
# Create a new auditreports model
swamp model create @swamp/gcp/auditmanager/auditreports my-auditreports

# Edit the model to configure its properties
swamp model edit my-auditreports

# Create the resource in GCP
swamp model method run my-auditreports create

# Sync current state from GCP
swamp model method run my-auditreports sync
```
