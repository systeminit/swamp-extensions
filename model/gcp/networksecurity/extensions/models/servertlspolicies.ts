...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: clientValidationCa, certificateProviderInstance, pluginInstance, grpcEndpoint, targetUri, clientValidationMode, clientValidationTrustConfig, certificateProviderInstance, pluginInstance, grpcEndpoint, targetUri",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          clientValidationCa: _clientValidationCa,
          certificateProviderInstance: _certificateProviderInstance,
          pluginInstance: _pluginInstance,
          grpcEndpoint: _grpcEndpoint,
          targetUri: _targetUri,
          clientValidationMode: _clientValidationMode,
          clientValidationTrustConfig: _clientValidationTrustConfig,
          ...rest
        } = old;
        return rest;
      },
