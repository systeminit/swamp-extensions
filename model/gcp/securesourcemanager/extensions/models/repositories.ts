...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: defaultBranch, gitignores, license, readme, secretScanConfig, enabled, inspectTemplate",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          ...
          license: _license,
          readme: _readme,
          secretScanConfig: _secretScanConfig,
          enabled: _enabled,
          inspectTemplate: _inspectTemplate,
          ...rest
        } = old;
        return rest;
      },
  ...
  methods: {
    ...
    fetch_blob: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        params["repository"] = existing["name"]?.toString() ??
          g["name"]?.toString() ?? "";
        if (args["sha"] !== undefined) params["sha"] = String(args["sha"]);
        const result = await createResource(
          baseUrl,
          {
            "id":
    ...
    fetch_tree: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["ref"] !== undefined) params["ref"] = String(args["ref"]);
        const result = await createResource(
          baseUrl,
          {
            "id":
