...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: bigQuerySource, inputUri, dense, entityIdColumns, staticDataSource, timeSeries, timestampColumn",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          bigQuerySource: _bigQuerySource,
          inputUri: _inputUri,
          dense: _dense,
          entityIdColumns: _entityIdColumns,
          staticDataSource: _staticDataSource,
          timeSeries: _timeSeries,
          timestampColumn: _timestampColumn,
          ...rest
        } = old;
        return rest;
      },
