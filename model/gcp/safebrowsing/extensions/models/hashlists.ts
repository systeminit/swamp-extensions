  ...
  methods: {
    ...
    batch_get: {
      ...
      arguments: z.object({
        ...
        sizeConstraints_maxDatabaseEntries: z.any().optional(),
        sizeConstraints_maxUpdateEntries: z.any().optional(),
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["sizeConstraints_maxDatabaseEntries"] !== undefined) {
          params["sizeConstraints.maxDatabaseEntries"] = String(
            args["sizeConstraints_maxDatabaseEntries"],
          );
        }
        if (args["sizeConstraints_maxUpdateEntries"] !== undefined) {
          params["sizeConstraints.maxUpdateEntries"] = String(
