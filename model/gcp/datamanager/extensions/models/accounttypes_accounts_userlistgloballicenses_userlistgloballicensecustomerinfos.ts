 ...
 *
 * GCP datamanager AccountTypes.Accounts.UserListGlobalLicenses.UserListGlobalLicenseCustomerInfos resource
 *
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "GCP datamanager AccountTypes.Accounts.UserListGlobalLicenses.UserListGlobalLi...",
      schema: StateSchema,
      lifetime: "infinite",
