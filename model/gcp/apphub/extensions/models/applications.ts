...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: businessOwners, email, criticality, type, developerOwners, email, environment, type, operatorOwners, email, type",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          businessOwners: _businessOwners,
          email: _email,
          criticality: _criticality,
          type: _type,
          developerOwners: _developerOwners,
          environment: _environment,
          operatorOwners: _operatorOwners,
          ...rest
        } = old;
        return rest;
      },
