...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: rolloutRestriction, actions, id, invokers, timeWindows, oneTimeWindows, timeZone, weeklyWindows, deliveryPipeline, id, target, id",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          rolloutRestriction: _rolloutRestriction,
          actions: _actions,
          id: _id,
          invokers: _invokers,
          timeWindows: _timeWindows,
          oneTimeWindows: _oneTimeWindows,
          timeZone: _timeZone,
          weeklyWindows: _weeklyWindows,
          deliveryPipeline: _deliveryPipeline,
          target: _target,
          ...rest
        } = old;
        return rest;
