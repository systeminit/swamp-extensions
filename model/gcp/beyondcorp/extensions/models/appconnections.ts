...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description: "Removed: host, port, appGateway, ingressPort, l7psc, uri",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          host: _host,
          port: _port,
          appGateway: _appGateway,
          ingressPort: _ingressPort,
          l7psc: _l7psc,
          uri: _uri,
          ...rest
        } = old;
  ...
  methods: {
    ...
    resolve: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        if (args["appConnectorId"] !== undefined) {
          params["appConnectorId"] = String(args["appConnectorId"]);
        }
        if (args["pageSize"] !== undefined) {
          params["pageSize"] = String(args["pageSize"]);
        }
