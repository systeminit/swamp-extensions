...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: csvOptions, delimiter, disableTypeInference, encoding, headerRows, enabled, excludePatterns, includePatterns, jsonOptions, disableTypeInference, encoding, schedule, readAccessMode, type",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          csvOptions: _csvOptions,
          delimiter: _delimiter,
          disableTypeInference: _disableTypeInference,
          encoding: _encoding,
          ...
          schedule: _schedule,
          readAccessMode: _readAccessMode,
          type: _type,
          ...rest
        } = old;
        return rest;
