...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: alternateUsePermission, annotations, deprecated, displayOrder, stringType, stringValues, arrayItems, constraints, required, enumValues, deprecated, index, index, mapItems, recordFields, type, typeId, typeRef",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          alternateUsePermission: _alternateUsePermission,
