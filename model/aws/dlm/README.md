...
Use `swamp model type describe @swamp/aws/dlm/lifecycle_policy` to see the full
...
```bash
# Create a new lifecycle_policy model
swamp model create @swamp/aws/dlm/lifecycle_policy my-lifecycle_policy

# Edit the model to configure its properties
swamp model edit my-lifecycle_policy

# Create the resource in AWS
swamp model method run my-lifecycle_policy create

# Sync current state from AWS
swamp model method run my-lifecycle_policy sync
```
