  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        const instanceName = (result.ACLName ?? g.ACLName)?.toString() ??
          "current";
    ...
    update: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const instanceName = g.ACLName?.toString() ?? "current";
    ...
    delete: {
      ...
      execute: async (args: { identifier: string }, context: any) => {
        ...
        const instanceName = context.globalArgs.ACLName?.toString() ??
          args.identifier;
